...
var Tabs = React4.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React4.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React4.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React4.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React4.useState(false);
  const [scrollerStyle, setScrollerStyle] = React4.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React4.useRef(null);
  const tabListRef = React4.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React4.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime4.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime4.jsx)(ScrollButtonComponent, {
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime4.jsx)(ScrollButtonComponent, {
      slots: {
  ...
  const indicator = (0, import_jsx_runtime4.jsx)(TabsIndicator, {
    ...TabIndicatorProps,
  ...
  let childIndex = 0;
  const children = React4.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(TabsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component,
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime4.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime4.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
//# sourceMappingURL=chunk-5VM5RIZR.js.map
